export const ChatSvg = () => {
  return (
    <svg
      ...
      className={
        'h-[17px] w-[24px] md:h-[25px] md:w-[32px] lg:h-[33px] lg:w-[40px] xl:h-[41px] xl:w-[48px]'
      }
    >
      <rect width="48" height="41" fill="url(#pattern0)" />
      <defs>
        <pattern
          id="pattern0"
        ...
        >
          <use
            ...
            transform="scale(0.0107527 0.0123457)"
          />
        </pattern>
        <image
          id="image0_1_18"
