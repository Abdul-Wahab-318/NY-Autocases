      ...
      <div className=" how-it-works-cards-wrapper images d-flex  mt-5 " style={{ height : 'auto'}}>
        ...
        <div className="card" style={{backgroundColor: 'white', marginBottom: '5rem'}}>
            <div id="flexcon" className="card-img-top">
                ...
                <div className="container  items-center justify-center"><span className="section-number">01.<br /></span><span className="section-text text-[8px] sm:text-sm md:text-sm lg:text-md xl:text-[27px]">Click<span style={{fontWeight: '700'}}> chat now.</span></span></div></div>
        </div>
        <div className="card" style={{backgroundColor: 'white', marginBottom: '5rem'}}>
            <div id="flexcon" className="card-img-top">
              <img src={how_it_works2} alt="" />
                <div className="container  items-center justify-center"><span className="section-number block text-[12px] sm:text-md md:text-lg lg:text-xl xl:text-[48px]">02. <br /></span><span className="section-text text-[8px] sm:text-sm md:text-sm lg:text-md xl:text-[27px]">Get connected to a lawyer.</span></div></div>
