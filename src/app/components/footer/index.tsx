          ...
          <div className="container text-center text-md-start pt-[80px]">
            <div className="row mt-3 mb-5">
              <div className="col-md-3 col-lg-4 col-xl-4 mb-4">
                ...
                <p className="fw-bold" style={{ color: '#5b5e63' , maxWidth : '340px' }}>
                  Haven fruitful doesn't over lesser days appear creeping
              ...
              <div className="col-md-2 col-lg-2 col-xl-3 mx-auto mb-4">
                ...
                <div className="fw-bold" style={{ color: '#5b5e63' }}>
                  ...
                  <p className="my-2">Phone : +8880 44338899</p>
                  <p>info@domain.com</p>
                </div>
              </div>
              <div className="col-md-3 col-lg-2 col-xl-3 mx-auto mb-4 footer-social">
