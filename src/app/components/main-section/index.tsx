...
const MainSection = () => {
  return (
    ...
    >
      ...
      <div className="absolute left-8 top-16 md:left-[76px] md:top-36 lg:left-[86px] lg:top-40 xl:left-[96px] xl:top-44">
        <span className="banner-title text-lg sm:text-lg md:text-2xl lg:text-3xl xl:text-4xl ">
          Your road to justice.
        </span>
        <span className="banner-text w-[420px] pt-1 text-[8px] sm:w-[190px] sm:text-xs sm:leading-4 md:w-[270px] md:text-md md:leading-7 lg:w-[445px] lg:text-lg lg:leading-8 xl:w-[445px] xl:text-[30px] xl:leading-9">
